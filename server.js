...
<link rel="stylesheet" href="/styles.css?v=20260804p">
</head>
<body>
${header()}
${bodyHtml}
${footer()}
<script src="/app.js?v=20260804p" defer></script>
</body>
</html>`;
}
...
function header() {
  ...
  <div class="container header-inner">
    <a class="brand" href="/"><img src="/img/banny-logo-cream.png" alt="Banny"></a>
    <nav class="nav">
